...
set(CONAN_FMT_ROOT "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29")
set(CONAN_INCLUDE_DIRS_FMT "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/include")
set(CONAN_LIB_DIRS_FMT "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/lib")
set(CONAN_BIN_DIRS_FMT )
set(CONAN_RES_DIRS_FMT )
set(CONAN_SRC_DIRS_FMT )
set(CONAN_BUILD_DIRS_FMT "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/")
...
# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_FMT "${CONAN_FRAMEWORKS_FMT}")
...
set(CONAN_LIBS_FRAMEWORKS_FMT ${CONAN_PKG_LIBS_FMT} ${CONAN_FRAMEWORKS_FOUND_FMT})
...
set(CONAN_INCLUDE_DIRS "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/lib" ${CONAN_LIB_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "/home/sandeep/.conan/data/fmt/5.3.0/bincrafters/stable/package/64e0d548df6221cdd04e8d9f0e6ca9cd75dcef29/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_FMT}" "${CONAN_LIB_DIRS_FMT}"
                                  CONAN_PACKAGE_TARGETS_FMT "${CONAN_SYSTEM_LIBS_FMT} "
                                  "" fmt)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_FMT_DEBUG}" "${CONAN_LIB_DIRS_FMT_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_FMT_DEBUG "${CONAN_SYSTEM_LIBS_FMT_DEBUG} "
                                  "debug" fmt)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_FMT_RELEASE}" "${CONAN_LIB_DIRS_FMT_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_FMT_RELEASE "${CONAN_SYSTEM_LIBS_FMT_RELEASE} "
                                  "release" fmt)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_FMT_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_FMT_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_FMT_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_FMT_RELWITHDEBINFO} "
                                  "relwithdebinfo" fmt)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_FMT_MINSIZEREL}" "${CONAN_LIB_DIRS_FMT_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_FMT_MINSIZEREL "${CONAN_SYSTEM_LIBS_FMT_MINSIZEREL} "
                                  "minsizerel" fmt)

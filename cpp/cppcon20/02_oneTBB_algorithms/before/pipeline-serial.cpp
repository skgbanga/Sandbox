...
void change_case_serial(std::ofstream& caseBeforeFile,
...
int main() {
  ...
  std::ofstream caseBeforeFile("serial_pipeline_before.txt");
  std::ofstream caseAfterFile("serial_pipeline_after.txt");
